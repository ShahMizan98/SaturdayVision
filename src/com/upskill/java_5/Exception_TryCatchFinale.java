...
public class Exception_TryCatchFinale {
	 ...
	 * 
	A. Built-in Exception - Built-in exception throws by java which explain certain error situation
	...
	try{
	  ...
	  System.out.println("Student age = " + ageVision[6]);
		...
		e.printStackTrace();
		System.out.println("Array member not avaiable ! ");
        ...
        try{
	        int num = Integer.parseInt("test");
		     ...
		     e.printStackTrace();
		    System.out.println("Its not a integer value");
        ...
        try{
	        throw new myException("test");
		     ...
		     e.printStackTrace();
		    System.out.println("This Exeption is define by User");
	        }
        finally{
